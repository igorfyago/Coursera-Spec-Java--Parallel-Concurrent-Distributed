...
public final class CoarseLists {
     ...
     *
     * DONE Implement the add, remove, and contains methods below to support
    ...
    public static final class CoarseList extends ListSet {
        /*
         * DONE Declare a lock for this class to be used in implementing the
         ...
         * {@inheritDoc}
         * <p>
         * DONE Use a lock to protect against concurrent access.
         */
        @Override
    ...
    public static final class RWCoarseList extends ListSet {
         ...
         * {@inheritDoc}
         *
         * DONE Use a read-write lock to protect against concurrent access.
         */
        @Override
        boolean add(final Integer object)  {
